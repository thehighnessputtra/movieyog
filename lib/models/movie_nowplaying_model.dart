...
MovieNowPlayingModel movieNowPlayingModelFromJson(String str) =>
    MovieNowPlayingModel.fromJson(json.decode(str));

String movieNowPlayingModelToJson(MovieNowPlayingModel data) =>
